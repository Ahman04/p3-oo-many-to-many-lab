...
class Contract:
    ...
    def contracts_by_date(cls, date):
        # return sorted list of contracts matching the given date
        matches = [c for c in cls.all if c.date == date]
        # sorting not needed since they are created in order, but keep this
        return matches
